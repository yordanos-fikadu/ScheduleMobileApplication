...
import '../db/Tables/sundayTable.dart' as db;
import './daysClass/days_class.dart';
class SundayScheduleHome extends StatefulWidget {
  const SundayScheduleHome({super.key});
  @override
  State<SundayScheduleHome> createState() => _SundayScheduleHomeState();
}

class _SundayScheduleHomeState extends State<SundayScheduleHome> {
  final _title = TextEditingController();
  final _content = TextEditingController();

  SundaySchedule input(String title, String content) {
    return SundaySchedule(title: title, content: content);
  }
