...
import '../db/Tables/thusdayTable.dart' as db;
import 'daysClass/days_class.dart';
class ThusdayScheduleHome extends StatefulWidget {
  const ThusdayScheduleHome({super.key});
  @override
  State<ThusdayScheduleHome> createState() => _ThusdayScheduleHomeState();
}

class _ThusdayScheduleHomeState extends State<ThusdayScheduleHome> {
  final _title = TextEditingController();
  final _content = TextEditingController();

  ThusdaySchedule input(String title, String content) {
    return ThusdaySchedule(title: title, content: content);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Thusday Schedule'),
          centerTitle: true,
        ),
