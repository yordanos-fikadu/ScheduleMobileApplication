...
import '../db/Tables/thursdayTable.dart' as db;
import '../days/daysClass/days_class.dart';
class ThursdayScheduleHome extends StatefulWidget {
  const ThursdayScheduleHome({super.key});
  @override
  State<ThursdayScheduleHome> createState() => _ThursdayScheduleHomeState();
}

class _ThursdayScheduleHomeState extends State<ThursdayScheduleHome> {
  final _title = TextEditingController();
  final _content = TextEditingController();

  ThursdaySchedule input(String title, String content) {
    return ThursdaySchedule(title: title, content: content);
  }
