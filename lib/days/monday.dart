...
import '../db/Tables/mondayTable.dart' as db;
import './daysClass/days_class.dart';
class MondayScheduleHome extends StatefulWidget {
  const MondayScheduleHome({super.key});
  @override
  State<MondayScheduleHome> createState() => _MondayScheduleHomeState();
}

class _MondayScheduleHomeState extends State<MondayScheduleHome> {
  final _title = TextEditingController();
  final _content = TextEditingController();

  MondaySchedule input(String title, String content) {
    return MondaySchedule(title: title, content: content);
  }
    ...
    return Column(
      ...
      children: [
        AlertDialog(
          ...
          title: Column(
            children: const [
              Text('Monday Schedule', textAlign: TextAlign.center),
