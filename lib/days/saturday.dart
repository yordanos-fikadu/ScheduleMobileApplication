...
import '../db/Tables/saturday.dart' as db;
import './daysClass/days_class.dart';
class SaturdayScheduleHome extends StatefulWidget {
  const SaturdayScheduleHome({super.key});
  @override
  State<SaturdayScheduleHome> createState() => _SaturdayScheduleHomeState();
}

class _SaturdayScheduleHomeState extends State<SaturdayScheduleHome> {
  final _title = TextEditingController();
  final _content = TextEditingController();

  SaturdaySchedule input(String title, String content) {
    return SaturdaySchedule(title: title, content: content);
  }
